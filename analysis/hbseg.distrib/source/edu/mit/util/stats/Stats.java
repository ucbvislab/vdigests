...
//     }
    ...
    public static double myLogGammaPdf2(double x, double a, double b){
        return (a-1)*Math.log(x) - x/b - Gamma.logGamma(a) - a * Math.log(b);
    }

    public static double myLogGammaGradient(double x, double a, double b){
        return (a-1)/x - 1/b;
    }
    ...
    **/
    ...
    /** pdf of a binomial distribution **/
    public static double binLogProb(int k, int n, double r){
        return binLogProb(k,n,r,new FastDoubleGamma());
    }
    
    public static double binLogProb(int k, int n, double r, FastGamma gamma){
        //could cache these logs -- that'd be smart
        //        return 0;
         return gamma.logGamma(n+1) - gamma.logGamma(k+1) - 
             gamma.logGamma(n-k+1) + k * Math.log(r) + (n-k) * Math.log(1-r);
    }
