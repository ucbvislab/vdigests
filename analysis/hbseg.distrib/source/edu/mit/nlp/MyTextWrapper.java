...
public class MyTextWrapper extends TextWrapper {
    ...
    public MyTextWrapper(MyTextWrapper dude){
        super(dude);
    }

    public MyTextWrapper(){ super(); }
    ...
    public int[][] createSparseWordOccurrenceTable(LexMap outmap){
        return createSparseWordOccurrenceTable(outmap, useStems_);
    }

    public int[][] createSparseWordOccurrenceTable(LexMap outmap, boolean useStems){
